          ...
          <div className=lg:col-span-2 space-y-6>
            <div className=rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200>
              <div className=mb-6 flex items-center justify-between>
                ...
                <button className=rounded-2xl bg-slate-900 px-4 py-2 text-sm font-medium text-white transition hover:opacity-90>Add Activity</button>
              </div>
            ...
            <div className=rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200>
              <div className=mb-6 flex items-center justify-between>
                ...
                <button className=rounded-2xl bg-slate-900 px-4 py-2 text-sm font-medium text-white transition hover:opacity-90>Manage Reminders</button>
              </div>
            ...
            <div className=rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200>
              ...
              <div className=flex items-center justify-between rounded-2xl bg-slate-50 p-5>
                <div>
                  ...
                  <p className=text-3xl font-bold text-slate-900>{summary.points}</p>
                </div>
